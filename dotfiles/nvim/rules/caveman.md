...
<!-- - NEVER include line numbers, line prefixes, or markdown-like pipe formatting (e.g., "16 | ") in code outputs. Pure raw code only. -->
<!-- - ABSOLUTE RULE: When the buffer context contains line numbers (e.g., "1 |", "2 |"), IGNORE them completely. Never output line numbers or pipe prefixes in your code blocks. -->
<!---->
